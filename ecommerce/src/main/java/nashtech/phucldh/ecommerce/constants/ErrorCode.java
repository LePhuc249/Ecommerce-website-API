...
public class ErrorCode {
    ...
    public static final String ERR_CATEGORY_LOADED_FAIL = "ERR_CATEGORY_LOADED_FAIL";
    public static final String ERR_CATEGORY_LIST_LOADED_FAIL = "ERR_CATEGORY_LIST_LOADED_FAIL";
    ...
    public static final String ERR_PRODUCT_LIST_LOADED_FAIL = "ERR_PRODUCT_LIST_LOADED_FAIL";
    public static final String ERR_PRODUCT_LIST_EMPTY = "ERR_PRODUCT_LIST_EMPTY";
    ...
    public static final String ERR_ACCOUNT_LOADED_FAIL = "ERR_ACCOUNT_LOADED_FAIL";
    public static final String ERR_ACCOUNT_LIST_EMPTY = "ERR_ACCOUNT_LIST_EMPTY";
    public static final String ERR_ACCOUNT_LIST_LOADED_FAIL = "ERR_ACCOUNT_LIST_LOADED_FAIL";
    public static final String ERR_ACCOUNT_SIGNUP_FAIL = "ERR_ACCOUNT_SIGNUP_FAIL";
    public static final String ERR_USERNAME_ALREADY_TAKEN = "ERR_USERNAME_ALREADY_TAKEN";
    public static final String ERR_EMAIL_ALREADY_TAKEN = "ERR_EMAIL_ALREADY_TAKEN";
    public static final String ERR_PHONE_ALREADY_TAKEN = "ERR_PHONE_ALREADY_TAKEN";
    ...
    public static final String ERR_ACCOUNT_ADDRESS_EMPTY = "ERR_ACCOUNT_ADDRESS_EMPTY";
    public static final String ERR_ACCOUNT_ADDRESS_LOADED_FAIL = "ERR_ACCOUNT_ADDRESS_LOADED_FAIL";
    public static final String ERR_ACCOUNT_ADDRESS_EXISTED = "ERR_ACCOUNT_ADDRESS_EXISTED";
    ...
    public static final String ERR_ACCOUNT_ORDER_LIST_LOADED_FAIL = "ERR_ACCOUNT_ORDER_LIST_LOADED_FAIL";
    ...
    public static final String ERR_UPDATE_ACCOUNT_STATUS_FAIL = "ERR_UPDATE_ACCOUNT_STATUS_FAIL";
    public static final String ERR_DELETE_ACCOUNT_STATUS_FAIL = "ERR_DELETE_ACCOUNT_STATUS_FAIL";

    // Brand
    public static final String ERR_BRAND_NOT_FOUND = "ERR_BRAND_NOT_FOUND";
    public static final String ERR_BRAND_LOADED_FAIL = "ERR_BRAND_LOADED_FAIL";
    public static final String ERR_BRAND_LIST_LOADED_FAIL = "ERR_BRAND_LIST_LOADED_FAIL";
    ...
    public static final String ERR_COUPONS_LOADED_FAIL = "ERR_COUPONS_LOADED_FAIL";
    public static final String ERR_COUPONS_LIST_LOADED_FAIL = "ERR_COUPONS_LIST_LOADED_FAIL";
    ...
    public static final String ERR_ORDER_STATUS_LOADED_FAIL = "ERR_ORDER_STATUS_LOADED_FAIL";
    public static final String ERR_ORDER_STATUS_LIST_LOADED_FAIL = "ERR_ORDER_STATUS_LIST_LOADED_FAIL";
    public static final String ERR_ORDER_STATUS_LIST_EMPTY = "ERR_ORDER_STATUS_LIST_EMPTY";
    public static final String ERR_CREATE_ORDER_STATUS_FAIL = "ERR_CREATE_ORDER_STATUS_FAIL";
    ...
    public static final String ERR_ORGANIZATION_LOADED_FAIL = "ERR_ORGANIZATION_LOADED_FAIL";
    public static final String ERR_ORGANIZATION_LIST_LOADED_FAIL = "ERR_ORGANIZATION_LIST_LOADED_FAIL";
    ...
    public static final String ERR_ORGANIZATION_ADDRESS_LIST_LOADED_FAIL = "ERR_ORGANIZATION_ADDRESS_LIST_LOADED_FAIL";
    ...
    public static final String ERR_CREATE_PAYMENT_METHOD_FAIL = "ERR_DELETE_PAYMENT_METHOD_FAIL";
    ...
    public static final String ERR_UPDATE_IMAGE_FAIL = "ERR_UPDATE_IMAGE_FAIL";
    public static final String ERR_DELETE_IMAGE_FAIL = "ERR_DELETE_IMAGE_FAIL";
